...
<div id="addCommentContainer">
  ...
  <div><span>当前节目是：<br>	
<font color=red>爱的华尔兹</font><br>
表演者：<br><font color=red>宋洪雪 孙立志 高 岩 马虎彪 康 洁 黄海明 王红娟 王庆磊 吴 琳 杨建超</font>
</span>
<br/></div>
</div>
 <?php $result = mysql_query("SELECT * FROM comments WHERE name='爱的华尔兹'");
...
$zongfen = mysql_query("SELECT avg(star) as 平均分 FROM comments WHERE name='爱的华尔兹'");
$rs = mysql_fetch_assoc($zongfen);
echo '<br>'.平均分.'&nbsp '.'<font size=33 color=4c8200>'.round($rs['平均分'],2).分.'</font>';
$xiaoshu = round($rs['平均分'],2);
$sql = "update huizong SET fenshu='$xiaoshu' WHERE name='爱的华尔兹'";
...
echo "Could not update record: ". mysqli_error($conn); }
        ...
        ?>
<a href=list17.php>下一个节目</a>
</div>
</div>
</div>
<script type="text/javascript" src="js/jquery.min.js"></script>
<script type="text/javascript" src="js/16.js"></script>
</body>
</html>