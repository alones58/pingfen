...
表演者：<br><font color=red>徐征超 宋洪雪 高华 钟晨雪 吴琳</font>
</span>
<br/></div>
<div id="star">
	...
	<form id="addCommentForm" method="post" action="">
    	<div><br><br>
		 <table width="80%" border="0">
		  ...
		  <tr>
			<td width="64%"><input type="hidden" name="name" id="name" value="百家笑谈 麻豆" /></td>
		  ...
		  <tr>
			...
			<td><input type="hidden" name="body" id="body" value="徐征超 宋洪雪 高华 钟晨雪 吴琳" /></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
